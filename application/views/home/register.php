                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user">
                                ...
                                <a href="<?php echo base_url('/index.php/test/login'); ?>" class="btn btn-primary btn-user btn-block">
                                    Register Account
                                </a>
                                <hr>
                                <a href="<?php echo base_url('/index.php/test/index'); ?>" class="btn btn-google btn-user btn-block">
                                    <i class="fab fa-google fa-fw"></i> Register with Google
                                </a>
                                <a href="<?php echo base_url('/index.php/test/index'); ?>" class="btn btn-facebook btn-user btn-block">
                                    <i class="fab fa-facebook-f fa-fw"></i> Register with Facebook
                                </a>
                            </form>
                            <hr>
                            <div class="text-center">
                                <a class="small" href="<?php echo base_url('/index.php/test/forgot_password'); ?>">Forgot Password?</a>
                            </div>
                            <div class="text-center">
                                <a class="small" href="<?php echo base_url('/index.php/test/login'); ?>">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
